        ...
        <div class="body-container">
            ...
            <div class="body-container__right">
                ...
                <div class="body-container__right__item">
                    <h1><a href="<c:url value="/home/detail.com?type=DP"/>">Xe Đạp Đường Phố</a></h1>                  
                    <div class="body-container__right__list-item">
                        <c:forEach var="bike" items="${listDP}">
                ...
                <!--item-->
                <div class="body-container__right__item">
                    <h1><a href="<c:url value="/home/detail.com?type=DH"/>">Xe Đạp Địa Hình</a></h1>                  
                    <div class="body-container__right__list-item">
                        <c:forEach var="bike" items="${listDH}">
                            <a href="<c:url value="/home/info.com?id=${bike.productId}"/>">
                                <img src="<c:url value="${bike.image}"/>"/>
                                <div class="body-container__right__item--sale-off">
                                    <span class="body-container__right__item--sale-off__angle"></span>
                ...
                <!--item-->
                <div class="body-container__right__item">
                    <h1><a href="<c:url value="/home/detail.com?type=D"/>">Xe Đạp Đua</a></h1>                  
                    <div class="body-container__right__list-item">
                        <c:forEach var="bike" items="${listD}">
                            <a href="<c:url value="/home/info.com?id=${bike.productId}"/>">
                                <img src="<c:url value="${bike.image}"/>"/>
                                <div class="body-container__right__item--sale-off">
                                    <span class="body-container__right__item--sale-off__angle"></span>
                ...
                <!--item-->
                <div class="body-container__right__item">
                    <h1><a href="<c:url value="/home/detail.com?type=G"/>">Xe Đạp Gấp</a></h1>                  
                    <div class="body-container__right__list-item">
                        <c:forEach var="bike" items="${listG}">
                            <a href="<c:url value="/home/info.com?id=${bike.productId}"/>">
                                <img src="<c:url value="${bike.image}"/>"/>
                                <div class="body-container__right__item--sale-off">
                                    <span class="body-container__right__item--sale-off__angle"></span>
                ...
                <!--item-->
                <div class="body-container__right__item">
                    <h1><a href="<c:url value="/home/detail.com?type=N"/>">Xe Đạp Nữ</a></h1>                  
                    <div class="body-container__right__list-item">
                        <c:forEach var="bike" items="${listN}">
                            <a href="<c:url value="/home/info.com?id=${bike.productId}"/>">
                                <img src="<c:url value="${bike.image}"/>"/>
                                <div class="body-container__right__item--sale-off">
                                    <span class="body-container__right__item--sale-off__angle"></span>
                ...
                <!--item-->
                <div class="body-container__right__item">
                    <h1><a href="<c:url value="/home/detail.com?type=TE"/>">Xe Đạp Trẻ Em</a></h1>                  
                    <div class="body-container__right__list-item">
                        <c:forEach var="bike" items="${listTE}">
                            <a href="<c:url value="/home/info.com?id=${bike.productId}"/>">
                                <img src="<c:url value="${bike.image}"/>"/>
                                <div class="body-container__right__item--sale-off">
                                    <span class="body-container__right__item--sale-off__angle"></span>
